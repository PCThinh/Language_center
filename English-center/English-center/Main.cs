...
namespace English_center
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            this.panelMenu.Cursor = Cursors.Default;
            this.pictureBox1.Cursor = Cursors.Default;
            this.btnAdmin.Cursor = Cursors.Default;
            this.btnCourse.Cursor = Cursors.Default;    
            this.btnStaff.Cursor = Cursors.Default; 
            this.btnStudent.Cursor = Cursors.Default;
            this.btnStudent.Cursor = Cursors.Default;
            this.panelbar.Cursor = Cursors.Default;
        ...
        private struct RGBColors
        {
            ...
            public static Color color7 = Color.FromArgb(15, 139, 251);
        }
        //Methods
        ...
        {
            this.txtUser.Text = this.Data;
            string name=txtUser.Text;
            if (mainmodel.checkusername(name)!="AD")
            {
